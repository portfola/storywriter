...
import SpeechControls from './src/components/SpeechControls';
import StoryManagement from './src/components/StoryManagement';

import { questions, placeholderMapping, storyTemplates } from './src/data/storyData';
...
const App = () => {
  ...
  const speak = async (text, isQuestion = false) => {
    if (isSpeaking) {
      await Speech.stop();
    }
